...
<html lang="en">
	<head>
		...
		<title>Anyar Bootstrap Template - Home</title>
	...
	<body>
		...
		<header id="header" class="fixed-top d-flex align-items-center">
			<div class="container d-flex align-items-center justify-content-between">
				<h1 class="logo"><a href="halaman_awal.php">Anyar</a></h1>
				<!-- Uncomment below if you prefer to use an image logo -->
				<!-- <a href=halaman_awal.php" class="logo"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
				...
				<div class="carousel-item active">
					<div class="carousel-container">
						...
						<p class="animate__animated animate__fadeInUp">
							Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et
				...
				<div class="card">
					<div class="card-body">
						<div class="card-header">
							...
							<p>Isikan data diri untuk menyewa</p>
						</div>
						<form action="proses/simpan.php" method="post">
							...
							<div class="form-group text-center">
								...
								<button type="submit" class="btn btn-md btn-success">Masuk</button>
							</div>
						</form>
					</div>
				</div>
