	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">
					<img src="dist/img/logo.png" width="50px">
					<b>E - LIBRARY</b>
				</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										APLIKASI PERPUSTAKAAN SMP ALODIA BEKASI
									</b>
								</span>
							</a>
						</li>
        ...
        ?>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="report/laporan_buku.php" target="blank">
									<i class="fa fa-file"></i>Laporan Buku</a>
							</li>
							<li>
								<a href="report/laporan_anggota.php" target="blank">
    ...
    ?>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy;
				<a href="#">SMP ALODIA BEKASI</a>.</strong> All rights reserved.
		</footer>
