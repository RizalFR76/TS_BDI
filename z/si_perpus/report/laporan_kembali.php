	...
	<center>
		...
		<table border="1" cellspacing="0" style="width: 100%">
			...
			<tbody>
				<?php
                  $no = 1;
                  $sql = $koneksi->query("SELECT b.judul_buku, a.nis, a.nama, s.tgl_kembali
                  from tb_sirkulasi s inner join tb_buku b on s.id_buku=b.id_buku
				  inner join tb_anggota a on s.nis=a.nis where status='KEM' order by tgl_kembali asc");
